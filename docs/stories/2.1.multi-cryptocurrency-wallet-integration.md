...
- `/apps/api/src/services/crypto/crypto.controller.ts` - Main crypto wallet controller with 10 API endpoints
...
- `/apps/api/package.json` - Added uuid and WalletConnect v2 SDK dependencies
