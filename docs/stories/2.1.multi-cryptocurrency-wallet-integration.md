...
- `/apps/api/src/services/crypto/crypto.controller.ts` - Main crypto wallet controller with 18 API endpoints
...
- `/apps/api/package.json` - Added uuid, WalletConnect v2 SDK, MetaMask SDK, and ethers.js dependencies
