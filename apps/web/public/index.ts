...
export { default as gatekeeper } from './gatekeeper.gif';
...
export { default as benji } from './benji.png';
...
export { default as problemsolve } from './problemsolve.gif';
export { default as tech } from './tech.gif';
