...
export default function SocialsWaitlist() {
	const [rotate, setRotate] = useState(0);
	const phrase = ["Stay", "Connected", "With", "Us"];
	...
	return (
		<section
						...
						<div className="w-[50%] sm:w-full xm:w-full flex sm:flex-col xm:flex-col justify-between gap-y-[20px]">
							<div>
								...
								<div className="flex flex-col gap-y-[10px]">
									<LinkHover
										...
										title="LinkedIn"
										href="https://linkedin.com/company/discard-tech"
									/>
									<LinkHover
										className="before:h-[1px] after:h-[1px] w-fit paragraph font-medium  capitalize flex flex-col before:bottom-[1px] after:bottom-[1px]"
										title="X (Twitter)"
										href="https://twitter.com/discardtech"
									/>
									<LinkHover
										className="before:h-[1px] after:h-[1px] w-fit paragraph font-medium  capitalize flex flex-col before:bottom-[1px] after:bottom-[1px]"
										title="Medium Blog"
										href="https://medium.com/@discardtech"
									/>
									<LinkHover
										className="before:h-[1px] after:h-[1px] w-fit paragraph font-medium  capitalize flex flex-col before:bottom-[1px] after:bottom-[1px]"
										title="Discord Community"
										href="https://discord.gg/discardtech"
									/>
								</div>
							</div>
							<div className="flex w-fit h-fit gap-x-[5px] group">
								<div className="rounded-[50px] border-[2px] border-[#21212155] group-hover:bg-secondry  py-[3px] px-[12px] cursor-pointer">
									<Link
										href="mailto:hello@discard.tech"
			...
			<motion.div
				...
				style={{ y: mq }}>
				<Phone className="w-[230px] h-[230px] md:w-[200px] md:h-[200px] sm:w-[150px] sm:h-[150px] xm:w-[150px] xm:h-[150px] sm:flex-col xm:flex-col" />
			</motion.div>
		</section>
	);
}