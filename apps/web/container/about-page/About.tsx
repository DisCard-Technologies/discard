							...
							<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-y-[40px]">
								<div className="flex flex-col gap-y-[20px]">
									<p className="paragraph font-NeueMontreal text-secondry">
										A team of engineers, innovators, and
										<br /> passionate collaborators, working
										<br /> together to build industry-shifting <br />
										software solutions that solve real-world
										<br />
										problems.
									</p>
								</div>
								<div className="flex flex-col gap-y-[20px]">
									<p className="paragraph font-NeueMontreal text-secondry">
										...
										<br />
										recognizable & influential technology
										<br /> companies of our time.
									</p>
								</div>
							</div>
						</div>
