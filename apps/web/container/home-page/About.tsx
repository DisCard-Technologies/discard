		...
		<section className="w-full bg-about padding-y rounded-t-[20px] z-20 relative mt-[-15px]">
			<div className="pl-[50px] sm:px-[20px] xm:px-[20px]">
				<h2 className="sub-heading font-medium font-NeueMontreal text-secondry">
					Discard is democratizing global finance by connecting
					<br className="sm:hidden xm:hidden" /> crypto wallets to&nbsp;
					<span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
						real-world payments.
					</span>
					&nbsp;Making currency, <br className="sm:hidden xm:hidden" />
					<span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
						universal,
					</span>
					&nbsp;accessible to billions, with&nbsp;
					<span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
						less fees.
					</span>
				</h2>
				...
				<div className="padding-x pb-[50px] w-full flex sm:flex-col xm:flex-col gap-[30px] justify-between">
					<div className="w-[50%] sm:w-full xm:w-full">
						<h3 className="sub-paragraph font-medium text-secondry font-NeueMontreal">
							We deliver a global payments platform <br />built for the future. With us, you can:
						</h3>
					</div>
					<div className="w-[50%] sm:w-full xm:w-full">
						<div className="w-full flex gap-[30px] h-full items-end sm:items-start sm:flex-col xm:items-start xm:flex-col">
							<div className="w-[40%] sm:w-[60%] xm:w-[60%]">
								<p className="sub-paragraph font-medium font-NeueMontreal text-secondry tracking-wide">
									Scale Globally: Our tailored infrastructure helps you reach new and emerging markets.
								</p>
								<p className="sub-paragraph font-medium font-NeueMontreal text-secondry pt-[10px] tracking-wide">
									Unify Currencies: Seamlessly accept crypto and fiat currencies in one platform.
								</p>
								<p className="sub-paragraph font-medium font-NeueMontreal text-secondry pt-[10px] tracking-wide">
									Drive Growth: Serve anyone, from a single user to billions of people, with a secure and reliable system.
								</p>
							</div>
							<div className="w-[60%] flex justify-end flex-col  sm:w-full xm:w-full">
								<h1 className="sub-paragraph font-medium font-NeueMontreal text-secondry pb-[10px]">
									S:
								</h1>
			...
			<div className="w-full flex justify-between padding-x sm:flex-col xm:flex-col gap-[30px]">
				<div className="flex flex-col gap-[30px]">
					<Heading title="Finance without Gatekeepers" />
					<div
