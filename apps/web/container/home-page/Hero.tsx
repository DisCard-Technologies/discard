...
import { benji, awwwards, ochiside } from "@/public";
			...
			<div className="w-full h-full flex flex-col justify-between">
				...
				<div className="w-full flex flex-col justify-between h-[75vh] sm:h-[85vh] xm:h-[85vh]">
					<div className="w-full flex justify-between gap-[20px] pl-[50px] md:pl-[30px] sm:pl-[20px] xm:pl-[20px]">
						...
						<div className="absolute bottom-[22vh] right-[20px] md:right-[10px] xm:hidden sm:hidden z-10">
							<Image
								src={benji}
								alt="benny frank mog"
								width={830}
								height={768}
								className="xm:hidden sm:hidden w-[830px] h-[768px] lg:w-[648px] lg:h-[600px] md:w-[540px] md:h-[500px]"
							/>
						</div>
						<div>
							<Image
							...
							<div className="w-[50%] xm:w-full sm:w-full flex justify-between xm:flex-col xm:items-start sm:flex-col sm:items-start gap-[20px]">
								<div>
									<p className="paragraph font-NeueMontreal text-secondry">
										From cash-only to crypto-ready
									</p>
								</div>
